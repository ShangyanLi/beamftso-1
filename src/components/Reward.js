...
export default function Reward() {
  ...
  return (
    <>
      <div className="shadow-2xl flex flex-col bg-black w-1/2 mx-10 mx-auto my-10 h-auto p-10 mx-10 border-collapse border border-black rounded-md">
        <label className="m-10 md:w-auto  mx-auto text-2xl text-white">Claim Reward</label>
        <table class="table-fixed py-8 text-center text-white">
          <thead className="border-b-4 border-double border-white space-y-5">
            <tr>
              <td>No</td>
              <td>Amount</td>
            </tr>
        ...
        <div className="flex flex-justify px-3 text-white">
        ...
        <div>&nbsp</div>
        <button
          className="glow-on-hover h-9 w-2/3 mx-auto p-1 border-collapse border border-white rounded-3xl bg-black text-white hover:bg-purple-700"
          onClick={claimReward}
        >
          Claim All Rewards
        </button>
