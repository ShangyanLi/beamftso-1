  ...
  return (
    <>
      <div className="shadow-2xl flex flex-col bg-black w-1/2 mx-10 mx-auto my-10 h-auto p-10 mx-10 border-collapse border border-black rounded-md">
        <label className="m-10 md:w-auto  mx-auto text-2xl text-white">Unwrap</label>
        ...
        <label className="md:w-auto mx-auto text-white">Available : {balance / 10 ** 18} WSGB</label>
        <div>&nbsp</div>
        <button
          className="glow-on-hover h-9 w-2/3 mx-auto p-1 border-collapse border border-white rounded-3xl bg-black text-white hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:ring-opacity-50"
          onClick={unwrap}
        >
          Unwrap
        </button>
